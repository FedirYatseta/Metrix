...
const ChatBlock: FC<IProps> = ({ data, setSelectUser }) => {
    return (
        <>
            {data.map((item: any, index: any) => (
                <div className={` py-3 flex ${inter.className} border-b border-stroke`} key={index} onClick={(e) => setSelectUser(e, item.id)} >
