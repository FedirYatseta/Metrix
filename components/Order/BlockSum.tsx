...
const BlockSum = ({ item, className }: any) => {
  ...
  return (
    <div className={`rounded-xl xs:px-2 lg:px-4 xs:py-2 lg:py-3  ${className.bg || 'bg-white'} `}>
      <div className="flex items-center justify-between">
        <div className={`p-2  ${className.bgImage || 'bg-secondary-400'} rounded-md`}>
      ...
      >
        <div className="flex flex-col text-start">
          <span
            className={` ${inter.className} ${className.titleColor} xs:text-sm lg:text-md`}
          >
            {item?.orders}
          </span>{" "}
        ...
        <div className="flex flex-col text-start">
          {" "}
          <span
            className={` ${inter.className} ${className.titleColor} xs:text-sm lg:text-md text-black-300`}
          >
            {item?.pending}
          </span>{" "}
          <span className={`xs:text-sm lg:text-xl font-medium ${className.color} `}>{item?.sumCount || 0}</span>
