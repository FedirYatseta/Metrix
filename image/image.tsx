...
export const Dash = ({ isActive }: any) => {
  if (!isActive) {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const Order = ({ isActive }: any) => {
  if (!isActive) {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M14.5134 20.5H6.16555C3.09919 20.5 0.746786 19.3925 1.41498 14.9348L2.19301 8.8936C2.60491 6.66934 4.02367 5.81808 5.26852 5.81808H15.447C16.7102 5.81808 18.0466 6.73342 18.5225 8.8936L19.3006 14.9348C19.8681 18.889 17.5797 20.5 14.5134 20.5Z"
          stroke="#53545C"
          stroke-width="1.5"
          stroke-linecap="round"
          stroke-linejoin="round"
        />
        <path
          d="M14.6502 5.5984C14.6502 3.21233 12.716 1.27804 10.3299 1.27804V1.27804C9.18088 1.27317 8.07727 1.7262 7.26308 2.53695C6.44889 3.34771 5.9912 4.44939 5.99121 5.5984H5.99121"
          stroke="#53545C"
          stroke-width="1.5"
          stroke-linecap="round"
          stroke-linejoin="round"
...
export const Customer = ({ isActive }: any) => {
  if (!isActive) {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      >
        ...
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M7.59108 10.0198C5.16908 10.0198 3.20508 8.0568 3.20508 5.6348C3.20508 3.2128 5.16908 1.2498 7.59108 1.2498C10.0121 1.2498 11.9761 3.2128 11.9761 5.6348C11.9851 8.0478 10.0351 10.0108 7.62208 10.0198H7.59108Z"
          stroke="#53545C"
          stroke-width="1.5"
          stroke-linecap="round"
          stroke-linejoin="round"
        />
        <path
          d="M14.4824 8.8816C16.0834 8.6566 17.3164 7.2826 17.3194 5.6196C17.3194 3.9806 16.1244 2.6206 14.5574 2.3636"
          stroke="#53545C"
          stroke-width="1.5"
          stroke-linecap="round"
          stroke-linejoin="round"
...
export const Inventory = ({ isActive }: any) => {
  if (!isActive) {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
    ...
    return (
      ...
      >
        ...
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M18.8321 4.54329C19.1521 4.91737 19.3993 5.34768 19.5612 5.81219C19.8798 6.76687 20.0273 7.77012 19.9969 8.7759V14.0289C19.9956 14.4714 19.963 14.9132 19.8991 15.3511C19.7775 16.1238 19.5057 16.8653 19.0989 17.5339C18.9119 17.8569 18.6849 18.155 18.4231 18.4213C17.2383 19.5087 15.665 20.0747 14.0574 19.9919H5.93061C4.32049 20.0741 2.74462 19.5083 1.55601 18.4213C1.2974 18.1545 1.07337 17.8564 0.889149 17.5339C0.484751 16.8658 0.21869 16.1236 0.1067 15.3511C0.0354894 14.914 -0.000192693 14.4718 9.42692e-07 14.0289V8.7759C-0.000172448 8.33718 0.0235732 7.89878 0.0711337 7.46264C0.0811349 7.38612 0.096136 7.31084 0.110982 7.23635C0.135731 7.11216 0.160048 6.99014 0.160048 6.86812C0.250307 6.34179 0.414959 5.83092 0.649079 5.35077C1.34261 3.86891 2.76525 3.11467 5.09481 3.11467H14.8754C16.1802 3.01376 17.4753 3.40656 18.5032 4.21498C18.6215 4.31535 18.7316 4.42515 18.8321 4.54329ZM4.97033 13.5409H15.0355H15.0533C15.2741 13.5505 15.4896 13.4715 15.6517 13.3214C15.8137 13.1714 15.9088 12.9628 15.9157 12.7423C15.9282 12.5485 15.8644 12.3575 15.7379 12.2099C15.5924 12.0116 15.3618 11.8932 15.1155 11.8905H4.97033C4.51365 11.8905 4.14343 12.2599 4.14343 12.7157C4.14343 13.1714 4.51365 13.5409 4.97033 13.5409Z"
          fill="white"
        />
      </svg>
    );
...
export const Conversation = ({ isActive }: any) => {
  if (!isActive) {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
    ...
    return (
      ...
      >
        ...
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M9.98024 11.2896C9.27024 11.2796 8.70024 10.7096 8.70024 9.99962C8.70024 9.29962 9.28024 8.71962 9.98024 8.72962C10.6902 8.72962 11.2602 9.29962 11.2602 10.0096C11.2602 10.7096 10.6902 11.2896 9.98024 11.2896ZM5.36984 11.2896C4.66984 11.2896 4.08984 10.7096 4.08984 10.0096C4.08984 9.29962 4.65984 8.72962 5.36984 8.72962C6.07984 8.72962 6.64984 9.29962 6.64984 10.0096C6.64984 10.7096 6.07984 11.2796 5.36984 11.2896ZM13.31 10.0096C13.31 10.7096 13.88 11.2896 14.59 11.2896C15.3 11.2896 15.87 10.7096 15.87 10.0096C15.87 9.29962 15.3 8.72962 14.59 8.72962C13.88 8.72962 13.31 9.29962 13.31 10.0096Z"
          fill="white"
        />
      </svg>
    );
...
export const Settings = ({ isActive }: any) => {
  if (!isActive) {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
    ...
    return (
      ...
      >
        <path
          d="M10.0117 12.8297C8.40726 12.8297 7.10938 11.5797 7.10938 10.0097C7.10938 8.43969 8.40726 7.17969 10.0117 7.17969C11.6162 7.17969 12.8834 8.43969 12.8834 10.0097C12.8834 11.5797 11.6162 12.8297 10.0117 12.8297Z"
          fill="white"
        />
        <path
          opacity="0.4"
...
export const Home = () => {
  return (
    ...
    >
      <path
        d="M5.09615 12.8548V10.8102C5.09614 10.2921 5.51744 9.87115 6.03928 9.86789H7.9554C8.47957 9.86789 8.9045 10.2898 8.9045 10.8102V12.8488C8.90449 13.2982 9.26967 13.6634 9.72229 13.6667H11.0295C11.6401 13.6682 12.2262 13.4285 12.6584 13.0005C13.0907 12.5724 13.3337 11.9912 13.3337 11.385V5.57724C13.3336 5.0876 13.115 4.62315 12.7367 4.30901L8.29564 0.782856C7.51933 0.166092 6.41057 0.186016 5.65725 0.830266L1.31167 4.30901C0.915486 4.61389 0.678694 5.07972 0.666992 5.57724V11.3791C0.666992 12.6425 1.69858 13.6667 2.97111 13.6667H4.24852C4.46644 13.6682 4.67598 13.5834 4.83064 13.431C4.9853 13.2785 5.07228 13.0711 5.07227 12.8548H5.09615Z"
        fill="#5570F1"
      />
    </svg>
  );
...
export const Ring = () => {
  return (
    ...
    >
      <path
        d="M14.4749 8.70444C13.8662 7.99357 13.5896 7.37753 13.5896 6.33095V5.9751C13.5896 4.61127 13.2757 3.73254 12.5932 2.85382C11.5414 1.48915 9.77064 0.666656 8.03718 0.666656H7.96347C6.26645 0.666656 4.55121 1.45138 3.48115 2.76066C2.76143 3.65701 2.4111 4.5735 2.4111 5.9751V6.33095C2.4111 7.37753 2.15269 7.99357 1.52573 8.70444C1.06441 9.22815 0.916992 9.90125 0.916992 10.6297C0.916992 11.3591 1.15635 12.0498 1.63671 12.6113C2.26367 13.2844 3.14904 13.7141 4.05345 13.7888C5.36287 13.9382 6.67228 13.9944 8.00074 13.9944C9.32837 13.9944 10.6378 13.9004 11.948 13.7888C12.8516 13.7141 13.737 13.2844 14.3639 12.6113C14.8435 12.0498 15.0837 11.3591 15.0837 10.6297C15.0837 9.90125 14.9362 9.22815 14.4749 8.70444Z"
        fill="#5570F1"
      />
      <path
        opacity="0.4"
        d="M9.67445 15.0236C9.25786 14.9347 6.71937 14.9347 6.30278 15.0236C5.94664 15.1059 5.56152 15.2972 5.56152 15.7169C5.58223 16.1172 5.81661 16.4706 6.14128 16.6946L6.14045 16.6955C6.56035 17.0228 7.05314 17.2309 7.56912 17.3056C7.84409 17.3434 8.12403 17.3417 8.40894 17.3056C8.92409 17.2309 9.41688 17.0228 9.83678 16.6955L9.83596 16.6946C10.1606 16.4706 10.395 16.1172 10.4157 15.7169C10.4157 15.2972 10.0306 15.1059 9.67445 15.0236Z"
        fill="#5570F1"
      />
    </svg>
  );
...
export const ArrLeft = () => {
  return (
    ...
    >
      <path
        d="M5.47206 8.52843C5.73241 8.78878 5.73241 9.21089 5.47206 9.47124C5.21171 9.73159 4.7896 9.73159 4.52925 9.47124L0.529248 5.47124C0.276862 5.21886 0.268031 4.81246 0.509216 4.54935L4.17588 0.549354C4.42468 0.277942 4.84639 0.259606 5.1178 0.508401C5.38921 0.757196 5.40755 1.17891 5.15875 1.45032L1.92341 4.97979L5.47206 8.52843Z"
        fill="#666666"
      />
    </svg>
  );
...
export const ArrRight = () => {
  return (
    ...
    >
      <path
        d="M0.527944 1.47157C0.267594 1.21122 0.267594 0.789108 0.527944 0.528758C0.788293 0.268409 1.2104 0.268409 1.47075 0.528758L5.47075 4.52876C5.72314 4.78114 5.73197 5.18754 5.49078 5.45065L1.82412 9.45065C1.57532 9.72206 1.15361 9.74039 0.882198 9.4916C0.610785 9.2428 0.59245 8.82109 0.841245 8.54968L4.07659 5.02021L0.527944 1.47157Z"
        fill="#666666"
      />
    </svg>
  );
...
export const SearchInput = () => {
  return (
    ...
    >
      ...
      />
      <path
        d="M14.0156 13.9043L16.9523 16.8334"
        stroke="#130F26"
        stroke-width="1.5"
        stroke-linecap="round"
        stroke-linejoin="round"
  ...
  return (
    ...
    >
      ...
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M9.82551 1.88599H4.18064C2.22285 1.88599 1 2.97661 1 4.98134V11.0144C1 13.0507 2.22285 14.1665 4.18064 14.1665H9.81933C11.7833 14.1665 13 13.0696 13 11.0649V4.98134C13.0062 2.97661 11.7895 1.88599 9.82551 1.88599Z"
        stroke="#53545C"
        stroke-width="1.5"
        stroke-linecap="round"
        stroke-linejoin="round"
...
export const CopyIcon = () => {
  return (
    ...
    >
      <path
        d="M10.6667 13.3333H5.33333C4.8029 13.3333 4.29419 13.1225 3.91912 12.7475C3.54405 12.3724 3.33333 11.8637 3.33333 11.3333V4.66658C3.33333 4.48977 3.2631 4.3202 3.13807 4.19518C3.01305 4.07016 2.84348 3.99992 2.66667 3.99992C2.48986 3.99992 2.32029 4.07016 2.19526 4.19518C2.07024 4.3202 2 4.48977 2 4.66658V11.3333C2 12.2173 2.35119 13.0652 2.97631 13.6903C3.60143 14.3154 4.44928 14.6666 5.33333 14.6666H10.6667C10.8435 14.6666 11.013 14.5963 11.1381 14.4713C11.2631 14.3463 11.3333 14.1767 11.3333 13.9999C11.3333 13.8231 11.2631 13.6535 11.1381 13.5285C11.013 13.4035 10.8435 13.3333 10.6667 13.3333ZM14 5.95992C13.9931 5.89867 13.9796 5.83834 13.96 5.77992V5.71992C13.9279 5.65137 13.8852 5.58836 13.8333 5.53325L9.83333 1.53325C9.77822 1.4814 9.71521 1.43864 9.64667 1.40659H9.58667L9.37333 1.33325H6.66667C6.13623 1.33325 5.62753 1.54397 5.25245 1.91904C4.87738 2.29411 4.66667 2.80282 4.66667 3.33325V9.99992C4.66667 10.5304 4.87738 11.0391 5.25245 11.4141C5.62753 11.7892 6.13623 11.9999 6.66667 11.9999H12C12.5304 11.9999 13.0391 11.7892 13.4142 11.4141C13.7893 11.0391 14 10.5304 14 9.99992V5.99992C14 5.99992 14 5.99992 14 5.95992ZM10 3.60659L11.7267 5.33325H10.6667C10.4899 5.33325 10.3203 5.26301 10.1953 5.13799C10.0702 5.01297 10 4.8434 10 4.66658V3.60659ZM12.6667 9.99992C12.6667 10.1767 12.5964 10.3463 12.4714 10.4713C12.3464 10.5963 12.1768 10.6666 12 10.6666H6.66667C6.48986 10.6666 6.32029 10.5963 6.19526 10.4713C6.07024 10.3463 6 10.1767 6 9.99992V3.33325C6 3.15644 6.07024 2.98687 6.19526 2.86185C6.32029 2.73682 6.48986 2.66659 6.66667 2.66659H8.66667V4.66658C8.66667 5.19702 8.87738 5.70573 9.25245 6.0808C9.62753 6.45587 10.1362 6.66658 10.6667 6.66658H12.6667V9.99992Z"
        fill="#8B8D97"
      />
    </svg>
  );
...
export const Upload = ({ color }: any) => {
  console.log('color', color)

  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
      <g clip-path="url(#clip0_241_9612)">
        <path d="M13.3337 13.3333L10.0003 10L6.66699 13.3333" stroke={color || '#1c1D22'} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M10 10V17.5" stroke={color || '#1c1D22'} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M16.9919 15.3249C17.8047 14.8818 18.4467 14.1806 18.8168 13.3321C19.1868 12.4835 19.2637 11.5359 19.0354 10.6388C18.807 9.7417 18.2865 8.94616 17.5558 8.37778C16.8251 7.80939 15.9259 7.50052 15.0002 7.4999H13.9502C13.698 6.52427 13.2278 5.61852 12.5752 4.85073C11.9225 4.08295 11.1042 3.47311 10.182 3.06708C9.25967 2.66104 8.25734 2.46937 7.25031 2.50647C6.24328 2.54358 5.25777 2.80849 4.36786 3.28129C3.47795 3.7541 2.7068 4.42249 2.1124 5.23622C1.51799 6.04996 1.11579 6.98785 0.936028 7.9794C0.756269 8.97095 0.803632 9.99035 1.07456 10.961C1.34548 11.9316 1.83291 12.8281 2.50021 13.5832" stroke={color || '#1c1D22'} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M13.3337 13.3333L10.0003 10L6.66699 13.3333" stroke={color || '#1c1D22'} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      </g>
      <defs>
        <clipPath id="clip0_241_9612">
          <rect width="20" height="20" fill="white" />
        </clipPath>
      </defs>
    </svg>)
...
export const WhiteImage = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
      ...
      <path d="M14.9398 11.4131H14.9488" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M10.9301 11.4131H10.9391" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M6.92128 11.4131H6.93028" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  )
}
...
export const BagIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="19" viewBox="0 0 17 19" fill="none">
      <path fill-rule="evenodd" clip-rule="evenodd" d="M11.7615 17.4166H4.80495C2.24965 17.4166 0.289314 16.4936 0.84614 12.7789L1.4945 7.74457C1.83775 5.89102 3.02005 5.18164 4.05743 5.18164H12.5395C13.5921 5.18164 14.7058 5.94442 15.1024 7.74457L15.7508 12.7789C16.2237 16.0741 14.3168 17.4166 11.7615 17.4166Z" stroke="#53545C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M11.876 4.99877C11.876 3.01038 10.2641 1.39847 8.27572 1.39847V1.39847C7.31822 1.39441 6.39854 1.77194 5.72005 2.44757C5.04156 3.12319 4.66015 4.04127 4.66016 4.99877H4.66016" stroke="#53545C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M10.7471 8.75151H10.709" stroke="#53545C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M5.88776 8.75151H5.84962" stroke="#53545C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  )
}
...
export const SendMessage = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
      <path d="M16.8565 1.14891C16.4398 0.723074 15.8232 0.565574 15.2482 0.732241L1.83984 4.60641C1.23318 4.77474 0.803176 5.25557 0.687342 5.86557C0.569009 6.48724 0.982342 7.27724 1.52234 7.60724L5.71484 10.1672C6.14484 10.4306 6.69984 10.3647 7.05568 10.0081L11.8565 5.20724C12.0982 4.95641 12.4982 4.95641 12.7398 5.20724C12.9815 5.44807 12.9815 5.84057 12.7398 6.09057L7.93068 10.8914C7.57401 11.2481 7.50734 11.8014 7.76984 12.2322L10.3315 16.4406C10.6315 16.9397 11.1482 17.2239 11.7148 17.2239C11.7815 17.2239 11.8565 17.2239 11.9232 17.2147C12.5732 17.1322 13.0898 16.6897 13.2815 16.0647L17.2565 2.75724C17.4315 2.19057 17.2732 1.57391 16.8565 1.14891" fill="#1C1D22" />
      <path opacity="0.4" fill-rule="evenodd" clip-rule="evenodd" d="M1.50956 13.0066C1.34956 13.0066 1.18956 12.9458 1.06789 12.8233C0.823724 12.5791 0.823724 12.1841 1.06789 11.94L2.20539 10.8016C2.44956 10.5583 2.84539 10.5583 3.08956 10.8016C3.33289 11.0458 3.33289 11.4416 3.08956 11.6858L1.95122 12.8233C1.82956 12.9458 1.66956 13.0066 1.50956 13.0066ZM4.64389 14.0003C4.48389 14.0003 4.32389 13.9395 4.20222 13.817C3.95806 13.5728 3.95806 13.1778 4.20222 12.9336L5.33972 11.7953C5.58389 11.552 5.97972 11.552 6.22389 11.7953C6.46722 12.0395 6.46722 12.4353 6.22389 12.6795L5.08556 13.817C4.96389 13.9395 4.80389 14.0003 4.64389 14.0003ZM4.85531 16.9736C4.97697 17.0961 5.13697 17.157 5.29697 17.157C5.45697 17.157 5.61697 17.0961 5.73864 16.9736L6.87697 15.8361C7.12031 15.592 7.12031 15.1961 6.87697 14.952C6.63281 14.7086 6.23697 14.7086 5.99281 14.952L4.85531 16.0903C4.61114 16.3345 4.61114 16.7295 4.85531 16.9736Z" fill="#1C1D22" />
    </svg>
  )
...
export const SmileIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="#5570F1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
...
export const ManIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 20 24" fill="none">
      <path d="M9.99585 15.7036C4.96402 15.7036 0.666016 16.4969 0.666016 19.6703C0.666016 22.8448 4.93718 23.6661 9.99585 23.6661C15.0277 23.6661 19.3257 22.8739 19.3257 19.6994C19.3257 16.5249 15.0557 15.7036 9.99585 15.7036" fill="#130F26" />
      <path opacity="0.4" d="M9.99627 12.681C13.4239 12.681 16.1703 9.93351 16.1703 6.50701C16.1703 3.08051 13.4239 0.333008 9.99627 0.333008C6.56977 0.333008 3.82227 3.08051 3.82227 6.50701C3.82227 9.93351 6.56977 12.681 9.99627 12.681" fill="#130F26" />
    </svg>
  )
}


export const Cancel = ({ color }: any) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
export const SaveIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path d="M19 21H5C4.46957 21 3.96086 20.7893 3.58579 20.4142C3.21071 20.0391 3 19.5304 3 19V5C3 4.46957 3.21071 3.96086 3.58579 3.58579C3.96086 3.21071 4.46957 3 5 3H16L21 8V19C21 19.5304 20.7893 20.0391 20.4142 20.4142C20.0391 20.7893 19.5304 21 19 21Z" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M17 21V13H7V21" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M7 3V8H15" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  )
}
...
export const PieChart = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
      <g clip-path="url(#clip0_327_12965)">
        <path d="M17.6747 13.2417C17.1445 14.4955 16.3153 15.6002 15.2596 16.4595C14.2038 17.3187 12.9537 17.9063 11.6184 18.1707C10.2831 18.4352 8.90337 18.3685 7.59981 17.9766C6.29624 17.5846 5.10854 16.8793 4.14053 15.9223C3.17253 14.9653 2.4537 13.7857 2.04688 12.4867C1.64006 11.1877 1.55765 9.8088 1.80685 8.47059C2.05605 7.13238 2.62926 5.87559 3.47639 4.81009C4.32351 3.74459 5.41875 2.90283 6.66635 2.3584" stroke="#5570F1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M18.3333 9.99984C18.3333 8.90549 18.1178 7.82185 17.699 6.81081C17.2802 5.79976 16.6664 4.8811 15.8926 4.10728C15.1187 3.33346 14.2001 2.71963 13.189 2.30084C12.178 1.88205 11.0943 1.6665 10 1.6665V9.99984H18.3333Z" stroke="#5570F1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      </g>
      <defs>
        <clipPath id="clip0_327_12965">
          <rect width="20" height="20" fill="white" />
        </clipPath>
      </defs>
    </svg>
...
export const PreviewIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
      <path opacity="0.4" d="M34.1102 47.3332H13.8881C5.97975 47.3332 0.666992 41.7866 0.666992 33.5298V14.4722C0.666992 6.21543 5.97975 0.666504 13.8881 0.666504H34.1126C42.0209 0.666504 47.3337 6.21543 47.3337 14.4722V33.5298C47.3337 41.7866 42.0209 47.3332 34.1102 47.3332Z" fill="#5570F1" />
      <path fill-rule="evenodd" clip-rule="evenodd" d="M22.2382 16.2416C22.2382 19.4383 19.6366 22.0399 16.4399 22.0399C13.2409 22.0399 10.6416 19.4383 10.6416 16.2416C10.6416 13.0449 13.2409 10.4409 16.4399 10.4409C19.6366 10.4409 22.2382 13.0449 22.2382 16.2416ZM41.2675 28.871C41.8112 29.3983 42.2008 30.0003 42.4575 30.642C43.2345 32.5833 42.8308 34.9167 42.0002 36.8393C41.0155 39.1283 39.1302 40.8573 36.7548 41.6133C35.7002 41.9517 34.5942 42.0963 33.4905 42.0963H13.9348C11.9888 42.0963 10.2668 41.6437 8.85517 40.7943C7.97083 40.2623 7.8145 39.0373 8.47017 38.2393C9.56683 36.9093 10.6495 35.5747 11.7415 34.2283C13.8228 31.6523 15.2252 30.9057 16.7838 31.5613C17.4162 31.832 18.0508 32.2403 18.7042 32.6697C20.4448 33.8223 22.8645 35.4043 26.0518 33.687C28.2305 32.4957 29.4952 30.4571 30.596 28.6828L30.6182 28.647C30.6922 28.5282 30.7657 28.4095 30.8389 28.2912C31.2132 27.6864 31.5819 27.0907 31.9995 26.5423C32.5175 25.8633 34.4402 23.74 36.9252 25.252C38.5095 26.204 39.8418 27.492 41.2675 28.871Z" fill="#5570F1" />
    </svg>
  )
}