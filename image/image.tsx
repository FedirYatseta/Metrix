    ...
    if (!isActive) {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="22" viewBox="0 0 21 22" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M14.5134 20.5H6.16555C3.09919 20.5 0.746786 19.3925 1.41498 14.9348L2.19301 8.8936C2.60491 6.66934 4.02367 5.81808 5.26852 5.81808H15.447C16.7102 5.81808 18.0466 6.73342 18.5225 8.8936L19.3006 14.9348C19.8681 18.889 17.5797 20.5 14.5134 20.5Z" stroke="#53545C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M14.6502 5.5984C14.6502 3.21233 12.716 1.27804 10.3299 1.27804V1.27804C9.18088 1.27317 8.07727 1.7262 7.26308 2.53695C6.44889 3.34771 5.9912 4.44939 5.99121 5.5984H5.99121" stroke="#53545C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M13.296 10.1018H13.2502" stroke="#53545C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M7.46492 10.1018H7.41916" stroke="#53545C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
        )
    }
    else {
    ...
    if (!isActive) {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                ...
                <path d="M6.48145 13.4629H15.2164" stroke="#53545C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
        )
    }
    else {
    ...
    if (!isActive) {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                ...
                <path d="M14.9398 11.4131H14.9488" stroke="#53545C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M10.9301 11.4131H10.9391" stroke="#53545C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M6.92128 11.4131H6.93028" stroke="#53545C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
        )
    }
    else {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path opacity="0.4" d="M10.02 0C4.21 0 0 4.74 0 10C0 11.68 0.49 13.41 1.35 14.99C1.51 15.25 1.53 15.58 1.42 15.89L0.75 18.13C0.6 18.67 1.06 19.07 1.57 18.91L3.59 18.31C4.14 18.13 4.57 18.36 5.081 18.67C6.541 19.53 8.36 19.97 10 19.97C14.96 19.97 20 16.14 20 9.97C20 4.65 15.7 0 10.02 0Z" fill="white" />
                <path fill-rule="evenodd" clip-rule="evenodd" d="M9.98024 11.2896C9.27024 11.2796 8.70024 10.7096 8.70024 9.99962C8.70024 9.29962 9.28024 8.71962 9.98024 8.72962C10.6902 8.72962 11.2602 9.29962 11.2602 10.0096C11.2602 10.7096 10.6902 11.2896 9.98024 11.2896ZM5.36984 11.2896C4.66984 11.2896 4.08984 10.7096 4.08984 10.0096C4.08984 9.29962 4.65984 8.72962 5.36984 8.72962C6.07984 8.72962 6.64984 9.29962 6.64984 10.0096C6.64984 10.7096 6.07984 11.2796 5.36984 11.2896ZM13.31 10.0096C13.31 10.7096 13.88 11.2896 14.59 11.2896C15.3 11.2896 15.87 10.7096 15.87 10.0096C15.87 9.29962 15.3 8.72962 14.59 8.72962C13.88 8.72962 13.31 9.29962 13.31 10.0096Z" fill="white" />
            </svg>
        )
    }
...
export const Ring = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="18" viewBox="0 0 16 18" fill="none">
            <path d="M14.4749 8.70444C13.8662 7.99357 13.5896 7.37753 13.5896 6.33095V5.9751C13.5896 4.61127 13.2757 3.73254 12.5932 2.85382C11.5414 1.48915 9.77064 0.666656 8.03718 0.666656H7.96347C6.26645 0.666656 4.55121 1.45138 3.48115 2.76066C2.76143 3.65701 2.4111 4.5735 2.4111 5.9751V6.33095C2.4111 7.37753 2.15269 7.99357 1.52573 8.70444C1.06441 9.22815 0.916992 9.90125 0.916992 10.6297C0.916992 11.3591 1.15635 12.0498 1.63671 12.6113C2.26367 13.2844 3.14904 13.7141 4.05345 13.7888C5.36287 13.9382 6.67228 13.9944 8.00074 13.9944C9.32837 13.9944 10.6378 13.9004 11.948 13.7888C12.8516 13.7141 13.737 13.2844 14.3639 12.6113C14.8435 12.0498 15.0837 11.3591 15.0837 10.6297C15.0837 9.90125 14.9362 9.22815 14.4749 8.70444Z" fill="#5570F1" />
            <path opacity="0.4" d="M9.67445 15.0236C9.25786 14.9347 6.71937 14.9347 6.30278 15.0236C5.94664 15.1059 5.56152 15.2972 5.56152 15.7169C5.58223 16.1172 5.81661 16.4706 6.14128 16.6946L6.14045 16.6955C6.56035 17.0228 7.05314 17.2309 7.56912 17.3056C7.84409 17.3434 8.12403 17.3417 8.40894 17.3056C8.92409 17.2309 9.41688 17.0228 9.83678 16.6955L9.83596 16.6946C10.1606 16.4706 10.395 16.1172 10.4157 15.7169C10.4157 15.2972 10.0306 15.1059 9.67445 15.0236Z" fill="#5570F1" />
        </svg>
    )
}
...
export const Bag = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="46" height="50" viewBox="0 0 46 50" fill="none">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M45.2832 35.7868L43.3609 20.3002C42.1899 14.7741 38.8757 12.5 35.7161 12.5H10.3293C7.12555 12.5 3.70086 14.6149 2.7066 20.3002L0.762262 35.7868C-0.828559 47.1574 5.02654 50 12.6713 50H33.3962C41.0189 50 46.6972 45.8839 45.2832 35.7868ZM15.7425 25.3714C14.5222 25.3714 13.533 24.3533 13.533 23.0973C13.533 21.8414 14.5222 20.8232 15.7425 20.8232C16.9627 20.8232 17.952 21.8414 17.952 23.0973C17.952 24.3533 16.9627 25.3714 15.7425 25.3714ZM28.0051 23.0973C28.0051 24.3533 28.9943 25.3714 30.2145 25.3714C31.4348 25.3714 32.424 24.3533 32.424 23.0973C32.424 21.8414 31.4348 20.8232 30.2145 20.8232C28.9943 20.8232 28.0051 21.8414 28.0051 23.0973Z" fill="#BEC0CA" />
            <path opacity="0.4" d="M35.4347 11.9358C35.4425 12.1297 35.4053 12.3228 35.3258 12.5H31.733C31.6634 12.3199 31.6266 12.1288 31.6242 11.9358C31.6242 7.14206 27.7247 3.25596 22.9144 3.25596C18.1041 3.25596 14.2046 7.14206 14.2046 11.9358C14.2376 12.1224 14.2376 12.3134 14.2046 12.5H10.5247C10.4918 12.3134 10.4918 12.1224 10.5247 11.9358C10.8043 5.26477 16.3125 0 23.0124 0C29.7122 0 35.2204 5.26477 35.5 11.9358H35.4347Z" fill="#BEC0CA" />
        </svg>
    )
}
...
export const Sort = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 16 17" fill="none">
            <path d="M14 5.66675H2C1.72667 5.66675 1.5 5.44008 1.5 5.16675C1.5 4.89341 1.72667 4.66675 2 4.66675H14C14.2733 4.66675 14.5 4.89341 14.5 5.16675C14.5 5.44008 14.2733 5.66675 14 5.66675Z" fill="#00092E" />
            <path d="M12 9H4C3.72667 9 3.5 8.77333 3.5 8.5C3.5 8.22667 3.72667 8 4 8H12C12.2733 8 12.5 8.22667 12.5 8.5C12.5 8.77333 12.2733 9 12 9Z" fill="#00092E" />
            <path d="M9.33366 12.3333H6.66699C6.39366 12.3333 6.16699 12.1066 6.16699 11.8333C6.16699 11.5599 6.39366 11.3333 6.66699 11.3333H9.33366C9.60699 11.3333 9.83366 11.5599 9.83366 11.8333C9.83366 12.1066 9.60699 12.3333 9.33366 12.3333Z" fill="#00092E" />
        </svg>
    )
}
